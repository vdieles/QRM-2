...
Using the function nrow we find out how many rows there are which are all the observations while using ncol gives us the total amount of columns which are all the variables that are being measured. Each observation is a different movie that is being 
